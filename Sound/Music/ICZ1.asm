s3p11_Header:
	...
	smpsHeaderPSG       s3p11_PSG1,	$00, $02, $00, $00
	smpsHeaderPSG       s3p11_PSG2,	$00, $06, $00, $00
...
s3p11_FM1:
	...
	dc.b	nF5, $06, nRst, $02, nF5, $06, nRst, nF5, $04, nF5, $06, nRst
	dc.b	nF5, $06, nRst, nF5, nRst, nG5, nRst, $2A, nD5, $06, nRst, $02
...
s3p11_FM3:
	...
	dc.b	$06, nRst, nC5, $06, nRst, nC5, nRst, nD5, nRst, $2A, nA4, $06
...
s3p11_FM4:
	...
	dc.b	$06, nRst, nF4, $06, nRst, nF4, nRst, nG4, nRst, $2A, nD4, $06
...
s3p11_FM5Jump00:
	...
	dc.b	nRst, $60, nRst, nRst, nRst, nRst, nRst, nRst, nRst
	smpsFMAlterVol      $FD
	smpsJump            s3p11_FM5Jump00

; DAC Data
s3p11_DAC:
	dc.b	dKickS3, $18, dKickS3, dKickS3, dKickS3
s3p11_DAC_Loop2:
        dc.b    $0C, dSnareS3, dSnareS3, $18
        dc.b    dKickS3, dKickS3, dSnareS3
s3p11_DAC_Loop3:
        dc.b    dKickS3, dSnareS3
        smpsLoop            $00, $03, s3p11_DAC_Loop3
	smpsJump            s3p11_DAC_Loop

s3p11_DAC_Loop:
        dc.b    $0C, dClapS3, dClapS3, $18
        smpsJump            s3p11_DAC_Loop3
